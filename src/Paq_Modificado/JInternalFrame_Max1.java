 ...
 * @author Alejandro
 */
public class JInternalFrame_Max1 extends javax.swing.JInternalFrame {
    ...
    private void btnSolucionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSolucionActionPerformed
        try {
            ...
            for (int i = 0; i < (restricciones + 1); i++) {
                for (int j = 0; j < (restricciones + variables + 1); j++) {
                    Matriz[i][j] = convert(jTable1.getValueAt(i, j + 1).toString());
                }
            }
...
//        return new BigDecimal(Double.parseDouble(s)).setScale(2, RoundingMode.HALF_UP).doubleValue();
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        System.out.println(new BigDecimal(200.3456).setScale(1, RoundingMode.HALF_UP).doubleValue());
        System.out.println(new BigDecimal(11.993).setScale(1, RoundingMode.HALF_UP).doubleValue());
        System.out.println(new BigDecimal(99.34).setScale(1, RoundingMode.HALF_UP).doubleValue());
        System.out.println(new BigDecimal(99.54).setScale(1, RoundingMode.HALF_UP).doubleValue());
        System.out.println(new BigDecimal(99.49).setScale(1, RoundingMode.HALF_UP).doubleValue());
        System.out.println(new BigDecimal(99.55).setScale(1, RoundingMode.HALF_UP).doubleValue());
